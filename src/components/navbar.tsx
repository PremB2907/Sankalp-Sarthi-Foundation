    ...
    <header className="sticky top-0 z-40 bg-[#F7F6F0]/95 backdrop-blur-md border-b border-[#17352D]/10 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Header Social Icons & Action CTAs */}
          <div className="hidden lg:flex items-center gap-5">
            
            {/* Clickable Social Media SVG Icons */}
            <div className="flex items-center gap-3 border-r border-[#17352D]/15 pr-4 text-[#17352D]/70">
              {/* Instagram */}
              <a
                ...
                className="hover:text-[#005B45] transition-colors"
              >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#F7F6F0] border-b border-[#17352D]/10 px-6 pt-4 pb-8 space-y-4 shadow-xl">
          ...
          {/* Mobile Social Links */}
          <div className="flex items-center justify-around py-2 text-[#17352D]/80">
            <a href={SITE_CONFIG.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-xs uppercase font-bold text-[#005B45]">Instagram ↗</a>
            <a href={SITE_CONFIG.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-xs uppercase font-bold text-[#005B45]">LinkedIn ↗</a>
            <a href={SITE_CONFIG.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-xs uppercase font-bold text-[#005B45]">Facebook ↗</a>
          </div>
